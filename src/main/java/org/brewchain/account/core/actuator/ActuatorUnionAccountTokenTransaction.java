...
@Slf4j
public class ActuatorUnionAccountTokenTransaction extends AbstractTransactionActuator implements iTransactionActuator {

	public ActuatorUnionAccountTokenTransaction(AccountHelper oAccountHelper, TransactionHelper oTransactionHelper,
	...
	public void onPrepareExecute(MultiTransaction oMultiTransaction, Map<String, Account.Builder> accounts)
		...
		if (StringUtils.isBlank(oInput.getToken())) {
