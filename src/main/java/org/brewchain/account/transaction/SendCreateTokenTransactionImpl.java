...
@Slf4j
@Data
public class SendCreateTokenTransactionImpl  extends SessionModules<SendCreateTokenTransaction>{
	...
	public String[] getCmds() {
		return new String[] { PTXTCommand.TOT.name() };
	}
	...
	@Override
	public void onPBPacket(final FramePacket pack, final SendCreateTokenTransaction pb, final CompleteHandler handler) {
