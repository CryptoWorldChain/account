...
@Slf4j
@Data
public class SendCallContractTransactionImpl extends SessionModules<SendCallContractTransaction> {
	...
	public String[] getCmds() {
		return new String[] { PTXTCommand.CAC.name() };
	}
	...
	@Override
	public void onPBPacket(final FramePacket pack, final SendCallContractTransaction pb, final CompleteHandler handler) {
