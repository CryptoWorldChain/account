...
@Data
@Slf4j
@Instantiate(name = "accoutdao_wrapper")
public class AccountDaoWrapper extends SessionModules<Message> {
	...
	public AccountDaoWrapper() {
		// super(proxyDao);
		this.storage = new Cache("pendingqueue_acounts", 100000, MemoryStoreEvictionPolicy.LRU, true,
				"./pendingcache_account", true, 0, 0, true, 120, null);
