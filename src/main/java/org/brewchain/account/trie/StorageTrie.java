...
@Instantiate(name = "Contract_StorageTrie")
@Slf4j
@Data
public class StorageTrie implements ActorService {
	...
	private static ExecutorService executor = Executors.newFixedThreadPool(4,
			new ThreadFactoryBuilder().setNameFormat("storagetrie-calc-thread-%d").build());;
