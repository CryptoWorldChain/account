...
import org.brewchain.frontend.core.transaction.ActuatorCreateUnionAccount;
import org.brewchain.frontend.core.transaction.ActuatorDefault;
import org.brewchain.frontend.core.transaction.TransactionTypeEnum;
import org.brewchain.frontend.core.transaction.iTransactionActuator;
import org.brewchain.frontend.dao.DefDaos;
import org.brewchain.frontend.exception.TransactionException;
import org.brewchain.frontend.gens.Act.Account;
import org.brewchain.frontend.gens.Act.AccountValue;
import org.brewchain.frontend.gens.Tx.MultiTransaction;
import org.brewchain.frontend.gens.Tx.MultiTransaction.Builder;
import org.brewchain.frontend.gens.Tx.MultiTransactionInput;
import org.brewchain.frontend.gens.Tx.MultiTransactionOutput;
import org.brewchain.frontend.gens.Tx.MultiTransactionSignature;
...
public class TransactionHelper implements ActorService {
	...
	public void CreateMultiTransaction(MultiTransaction.Builder oMultiTransaction) throws Exception {
		...
		if (oMultiTransaction.getDelegateCount() == 0
				|| oMultiTransaction.getDelegateList().indexOf(ByteString.copyFrom(KeyConstant.COIN_BASE_BYTE)) != -1) {
			// 如果指定了委托，并且委托是本节点
	...
	private void verifyAndSaveMultiTransaction(MultiTransaction.Builder oMultiTransaction) throws Exception {
		...
		for (MultiTransactionSignature oMultiTransactionSignature : oMultiTransaction.getSignaturesList()) {
			verifySignature(oMultiTransactionSignature.getPubKey(), oMultiTransactionSignature.getSignature(),
