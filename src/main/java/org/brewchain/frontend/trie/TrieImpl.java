package org.brewchain.frontend.trie;
...
import static org.brewchain.frontend.util.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.brewchain.frontend.util.RLP.EMPTY_ELEMENT_RLP;
import static org.brewchain.frontend.util.RLP.encodeElement;
import static org.brewchain.frontend.util.RLP.encodeList;

public class TrieImpl implements ActorService {
	...
	public TrieImpl(TrieCache cache) {
		this(cache, null);
	}

	public TrieImpl(TrieCache cache, byte[] root) {
		this.cache = cache;
		setRoot(root);
	}
